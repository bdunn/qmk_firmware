...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LCBR, KC_LGUI, 			KC_EXLM, KC_RCBR, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, 
				KC_TILD, KC_RALT, KC_NO, MO(1), KC_BSPC, KC_DEL, MO(2), KC_SPC, KC_ENT, RCTL(KC_F)
	),

	[LAYER1] = LAYOUT(
	KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_5, 						KC_LCBR, KC_RCBR, KC_MINS, KC_EQL, KC_NO, KC_NO, 
	KC_TRNS, KC_6, KC_7, KC_8, KC_9, KC_0, 						KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_LBRC, KC_RBRC, 
	KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, 			KC_TRNS, KC_NO, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_NO, KC_TRNS, 
				KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, RCTL(KC_F)),
